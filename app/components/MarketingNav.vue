...
const featuresCol3b = [
  ...
  { title: 'Audio Studio', subtitle: 'Owned AI voiceover for every channel', icon: 'i-lucide-mic', iconBg: 'bg-rose-500/15', iconColor: 'text-rose-400', to: '/features/audio-studio' },
]
