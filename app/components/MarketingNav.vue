...
const featuresCol2 = [
  ...
  { title: 'Measurement Control', subtitle: 'Account, evidence, calls & freshness', icon: 'i-lucide-route', iconBg: 'bg-cyan-500/15', iconColor: 'text-cyan-400', to: '/features/measurement-control-plane' },
