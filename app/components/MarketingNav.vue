...
const featuresCol3b = [
  { title: 'Page Studio', subtitle: 'Plan, prepare and govern client websites', icon: 'i-lucide-panels-top-left', iconBg: 'bg-rose-500/15', iconColor: 'text-rose-400', to: '/features/page-studio' },
