...
const featuresCol2 = [
  ...
  { title: 'Ad Spend', subtitle: 'Meta spend plus Google Ads calls & performance', icon: 'i-lucide-bar-chart-3', iconBg: 'bg-emerald-500/15', iconColor: 'text-emerald-400', to: '/platform/ad-spend' },
...
const featuresCol4 = [
  ...
  { title: 'AI Assistant Connectors', subtitle: 'Governed campaign, creative & model Godmode', icon: 'i-lucide-plug', iconBg: 'bg-amber-500/15', iconColor: 'text-amber-400', to: '/features/ai-connectors' },
]
