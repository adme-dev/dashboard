...
const featuresCol2 = [
  ...
  { title: 'Measurement Signal Centre', subtitle: 'Privacy-safe server-side measurement', icon: 'i-lucide-waypoints', iconBg: 'bg-cyan-500/15', iconColor: 'text-cyan-400', to: '/features/measurement-signal-centre' },
...
const featuresCol3b = [
  { title: 'Page Studio', subtitle: 'Website plans, editing and publishing', icon: 'i-lucide-panels-top-left', iconBg: 'bg-rose-500/15', iconColor: 'text-rose-400', to: '/features/page-studio' },
