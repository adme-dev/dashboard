        ...
        >
          <template #actions>
            <UButton
              ...
              @click="connectMeta('catalog', selectedConnectionId)"
            >
      ...
      <template #content>
        <UForm :schema="createSchema" :state="createState" class="@container space-y-5 p-6" @submit="submitCreate">
          ...
          <div class="flex justify-end gap-2">
            <UButton type="button" color="neutral" variant="ghost" @click="closeCreate">Cancel</UButton>
    ...
    <UModal v-model:open="renameOpen" class="max-w-lg">
      <template #content>
        <UForm :schema="renameSchema" :state="renameState" class="@container space-y-5 p-6" @submit="submitRename">
          ...
          <div class="flex justify-end gap-2">
            <UButton type="button" color="neutral" variant="ghost" @click="closeRename">Cancel</UButton>
    ...
    <UModal v-model:open="deleteOpen" class="max-w-lg">
      <template #content>
        <div class="@container space-y-5 p-6">
          ...
          <div class="flex justify-end gap-2">
            <UButton type="button" color="neutral" variant="ghost" @click="closeDelete">Cancel</UButton>
