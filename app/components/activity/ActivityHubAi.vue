...
<template>
  <div class="flex flex-col h-full">
    ...
    <div
      ...
      class="flex-1 overflow-y-auto px-3 py-2 space-y-2.5"
    >
      <!-- Empty state -->
    ...
    <div class="border-t border-default px-3 py-2">
      <div class="flex items-end gap-2">
        <textarea
          ...
          class="flex-1 resize-none bg-transparent text-sm outline-none placeholder:text-muted max-h-20 min-h-[36px]"
          rows="1"
      ...
      <div class="flex items-center justify-between mt-1">
        ...
        <button
          ...
          @click="toggleSize"
        >
          <UIcon name="i-lucide-maximize-2" class="w-3 h-3" />
        </button>
      </div>
    </div>
  </div>
