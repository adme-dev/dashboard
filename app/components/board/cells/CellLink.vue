    ...
    <template v-if="editing">
      <div class="flex items-center gap-1 w-full" @click.stop>
        <input
          ...
          type="url"
          placeholder="https://..."
          class="flex-1 px-1 py-0.5 text-sm border border-gray-200 dark:border-neutral-700 rounded outline-none focus:border-blue-500 bg-white dark:bg-neutral-800 dark:text-neutral-100"
          @keydown.enter="save"
