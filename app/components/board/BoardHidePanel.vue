<template>
  <div class="w-64 p-3">
    <div class="flex items-center justify-between mb-3">
      ...
      <span class="text-xs text-gray-500">{{ visibleCount }} of {{ (allColumns || []).length }} visible</span>
    </div>
    ...
    <div class="space-y-1 max-h-64 overflow-y-auto">
      ...
      >
        ...
        />
        <span class="truncate" :class="col.isVisible === false ? 'text-gray-400' : 'text-gray-700'">
          {{ col.name }}
        </span>
      </label>
    </div>
