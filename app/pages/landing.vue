          ...
          <div class="flex flex-col md:flex-row gap-12 md:gap-0 md:justify-between mb-20">
            ...
            <div class="flex gap-20 md:gap-28">
              <div class="flex flex-col gap-3.5 text-[15px]">
                ...
                <NuxtLink to="/ai-training" class="text-white/50 hover:text-white transition-colors">AI Training</NuxtLink>
                <NuxtLink to="/landing" class="text-white/50 hover:text-white transition-colors">Landing Page</NuxtLink>
