      ...
      <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">
            Connect XeroFlow clients to social-dashboard inventory feeds for Google and Facebook catalogs.
          </p>
        </div>
    ...
    <div class="p-6 space-y-6">
      <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div
          v-for="stat in stats"
          :key="stat.label"
          class="rounded-lg border border-default bg-white px-4 py-3"
        >
      ...
      <div class="grid grid-cols-1 gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
        <section class="rounded-lg border border-default bg-white">
          ...
          <div class="space-y-4 p-5">
            ...
            <div
              v-if="selectedClient"
              class="rounded-lg border border-default bg-gray-50 px-3 py-2"
            >
