<template>
  <div class="min-h-screen bg-white dark:bg-[#0a0b0e]">
    ...
    <section class="pt-[52px]">
      <div class="max-w-[1200px] mx-auto px-6 pt-32 pb-12 md:pt-44 md:pb-20 text-center">
        <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#121317]/[0.04] dark:bg-white/[0.06] mb-8">
          <div class="w-1.5 h-1.5 rounded-full bg-emerald-500" />
          <span class="text-[13px] text-[#45474D] dark:text-white/60 font-medium">Simple, transparent pricing</span>
        </div>
        ...
        <p class="text-lg md:text-xl text-[#45474D] dark:text-white/60 max-w-[600px] mx-auto leading-relaxed">
    ...
    <section class="py-10 md:py-16">
      <div class="max-w-[1200px] mx-auto px-6">
        <div class="rounded-[2rem] bg-[#0a0b0e] py-20 md:py-28 text-center px-6">
          <div class="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center mx-auto mb-6">
