...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Lead Capture & Routing', slug: 'lead-capture-routing', icon: 'i-lucide-inbox', description: 'Real-time Meta + Google ad inquiries land in the dashboard. Per-form rules fan them out to Slack, email, your CRM, Sheets, and the client portal — without Zapier.' },
