...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Lead Capture & Routing', slug: 'lead-capture-routing', icon: 'i-lucide-inbox', description: 'One inbox for Google Ads, Meta, Zapier/Make/n8n, CSV imports, and manual entry, plus dedicated inbound email and direct AutoGate/carsales delivery for automotive leads.' },
