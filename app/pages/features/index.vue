...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Google Tag Manager', slug: 'google-tag-manager', icon: 'i-lucide-container', description: 'Connect GTM, link a client container, create isolated tracking versions, publish with explicit approval, verify live tags, and roll back safely.' },
