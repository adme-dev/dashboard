...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Website Audience Intelligence', slug: 'website-audience-intelligence', icon: 'i-lucide-radio-tower', description: 'Discover a non-exhaustive list of up to 20 nearby dealerships, then require human review and approval before any public competitor site is monitored.' },
