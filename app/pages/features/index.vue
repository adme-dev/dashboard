...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Campaign Alerts', slug: 'campaign-alerts', icon: 'i-lucide-bell-ring', description: 'Detects ad-spend pacing problems and adds an AI pacing review for Meta and Google — including an on-demand, per-campaign "Analyze with AI" that proposes a daily budget side-by-side with the rule-based number for you to choose.' },
      ...
      { title: 'Measurement Signal Centre', slug: 'measurement-signal-centre', icon: 'i-lucide-waypoints', description: 'Govern privacy-safe browser and server-side measurement across TikTok, Meta, Google, and GA4, with consent, delivery health, and redacted event evidence in one place.' },
