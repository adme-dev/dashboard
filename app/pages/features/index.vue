...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Email Builder', slug: 'email-builder', icon: 'i-lucide-layout-template', description: 'Visual section-based email editor — drop in pre-designed sections with live previews, start from curated templates, and render to bulletproof email HTML.' },
