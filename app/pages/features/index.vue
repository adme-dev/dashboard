...
const categories = [
  ...
  },
  {
    ...
    iconColor: 'text-rose-600',
    features: [
      { title: 'Page Studio', slug: 'page-studio', icon: 'i-lucide-panels-top-left', description: 'Build multi-page client websites with nested pages, reusable sections, responsive previews, governed drafts, releases, and domains.' },
  ...
  { title: 'Google Ads Control & Tracking', slug: 'google-ads-tracking', icon: 'i-lucide-bar-chart-3', description: 'Secure multi-account reporting plus governed campaign, targeting, creative, conversion, and optimization controls through XeroFlow\'s Google Ads MCP.' },
