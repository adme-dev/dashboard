...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Dealer Inventory Feeds', slug: 'dealer-inventory-feeds', icon: 'i-lucide-boxes', description: 'Map database-backed vehicle inventory to a client, verify Meta catalogue access, attach scheduled feeds, and retain provider-readback evidence inside XeroFlow.' },
      ...
      { title: 'QR Codes', slug: 'qr-codes', icon: 'i-lucide-qr-code', description: 'Generate print-safe QR codes for portal links, proofs and campaigns — encoded in the browser, exported as PNG or SVG, with optional client self-serve in the portal.' },
