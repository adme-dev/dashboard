...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Google Ads Tracking', slug: 'google-ads-tracking', icon: 'i-lucide-bar-chart-3', description: 'Agency-wide Google Ads spend, approval and serving diagnostics, impression share, search terms, creative copy, and call reporting across secure manager-account connections.' },
