...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Lead Capture & Routing', slug: 'lead-capture-routing', icon: 'i-lucide-inbox', description: 'One inbox for Google Ads, Meta, dedicated inbound email, Zapier/Make/n8n, CSV imports, and manual entry. Per-form rules fan leads out to Slack, email, your CRM, Sheets, and the client portal.' },
