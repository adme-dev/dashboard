...
const categories = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Meta Ads Tracking', slug: 'meta-ads-tracking', icon: 'i-lucide-megaphone', description: 'OAuth-connected Meta spend syncing with policy issues, ad-set learning state, frequency, CPM, campaign budgets, and guarded Business-scoped catalog management for vehicle inventory.' },
