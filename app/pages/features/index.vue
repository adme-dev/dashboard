...
const categories = [
  ...
  },
  {
    ...
    iconColor: 'text-rose-600',
    features: [
      { title: 'Page Studio', slug: 'page-studio', icon: 'i-lucide-panels-top-left', description: 'Build and launch responsive websites with reviewed setup and subscription safeguards, scoped business content, agency review, site-specific booking tools, usage controls, domains, releases and rollback.' },
