...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Lead Capture & Routing', slug: 'lead-capture-routing', icon: 'i-lucide-inbox', description: 'One inbox for Google Ads, Meta, Zapier/Make/n8n, CSV imports, and manual entry, plus dedicated inbound email that securely captures each client\'s CRM conversation. The address is shown only once at creation or rotation.' },
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Owner God Mode', slug: 'owner-god-mode', icon: 'i-lucide-crown', description: 'Always-on access to every registered application and MCP capability for active owners, with authentication, tenant isolation, mandatory audit and emergency controls still enforced. Ordinary employees remain governed.' },
