...
const categories = [
  ...
  },
  {
    ...
    iconColor: 'text-rose-600',
    features: [
      { title: 'Page Studio', slug: 'page-studio', icon: 'i-lucide-panels-top-left', description: 'Configure client website access and limits, review customer-submitted setup plans and missing business facts, prepare approved websites where setup is enabled, then build drafts with components and AI through governed releases.' },
