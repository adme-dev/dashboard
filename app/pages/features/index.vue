...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Search Authority & AI Trust', slug: 'search-authority-ai-trust', icon: 'i-lucide-search-check', description: 'Turn first-party Search Console and indexed-version evidence into explainable opportunities, governed tasks, and transparent client reporting.' },
