...
const categories = [
  ...
  },
  {
    ...
    features: [
      { title: 'Lead Capture & Routing', slug: 'lead-capture-routing', icon: 'i-lucide-inbox', description: 'Signed gateways, native ad forms, inbound email, safe tests, and exact automotive routing into one real-time inbox.' },
