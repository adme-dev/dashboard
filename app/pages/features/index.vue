...
const categories = [
  ...
  },
  {
    ...
    iconColor: 'text-rose-600',
    features: [
      { title: 'Page Studio', slug: 'page-studio', icon: 'i-lucide-panels-top-left', description: 'Create client website drafts from an agency portfolio, then build and launch with reviewed setup, subscription safeguards, scoped content, booking tools, domains, releases and rollback.' },
