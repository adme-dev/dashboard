  ...
  <div class="min-h-screen bg-white dark:bg-[#0a0b0e]">
    ...
    <section class="relative bg-[#0a0b0e] pt-[52px]">
      ...
      <div class="relative max-w-[720px] mx-auto px-6 pt-32 md:pt-44 pb-16 md:pb-20">
        ...
        <p class="text-[15px] text-white/40">Effective date: 4 March 2026</p>
      </div>
    </section>
        ...
        <div class="flex flex-col gap-12">
          ...
          <section>
            ...
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed mt-3">
              <strong class="text-[#121317] dark:text-white/80 font-[450]">We do not sell your personal information to third parties.</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 flex flex-col gap-1.5 text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
              ...
              <li><strong class="text-[#121317] dark:text-white/80 font-[450]">Usage &amp; log data</strong> &mdash; retained for up to 12 months, then aggregated or deleted.</li>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 flex flex-col gap-1.5 text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
              <li>Encryption in transit (TLS 1.2+) and at rest (AES-256) for all data.</li>
          ...
          <section>
            ...
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
              This Privacy Policy is governed by the laws of the State of New South Wales, Australia, and the Commonwealth of Australia, including the <em>Privacy Act 1988</em> (Cth) and the Australian Privacy Principles (APPs). Where the GDPR or UK GDPR applies to you, nothing in this policy limits your rights under those regulations.
            </p>
          </section>
