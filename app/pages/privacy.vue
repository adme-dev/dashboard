    ...
    <div>
      <div class="max-w-[720px] mx-auto px-6 pt-12 pb-20 md:pb-32">
        ...
        <div class="prose-legal flex flex-col gap-10">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">2. How We Use Your Information</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">3. Data Storage & Security</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">4. Third-Party Services</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">5. Cookies & Tracking</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">6. Your Rights</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
          ...
          <section>
            <h2 class="text-[20px] font-[450] text-[#121317] dark:text-white mb-4">7. Contact Us</h2>
            <p class="text-[15px] text-[#45474D] dark:text-white/60 leading-relaxed">
              For any privacy-related questions or requests, please contact us at
              <a href="mailto:privacy@xeroflow.agency" class="text-[#121317] dark:text-white underline underline-offset-2">privacy@xeroflow.agency</a>.
            </p>
          </section>
        </div>
      </div>
