/**
 * Stash primitive CF Pages configuration into a module-level cache on every request so
 ...
 * event.context.cloudflare.env. Native object bindings are never cached; callers
 * must carry those request capabilities explicitly.
 */
