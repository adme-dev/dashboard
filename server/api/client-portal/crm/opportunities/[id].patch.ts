...
export default defineEventHandler(async (event) => {
  ...
  for (const col of ['name', 'person_id', 'company_id', 'amount', 'probability', 'expected_close_date', 'source', 'competitor', 'lost_reason', 'notes', 'next_action', 'next_action_date'] as const) {
