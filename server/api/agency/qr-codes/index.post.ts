  ...
  for (let attempt = 0; attempt < 5; attempt++) {
    ...
    try {
      const row = await queryOne<any>(
        `INSERT INTO qr_codes (client_id, folder_id, code, name, destination_url, style, created_by, utm_enabled, utm_medium)
         VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9) RETURNING *`,
        [body.clientId, body.folderId ?? null, code, body.name, dest.url, JSON.stringify(body.style), user.id, body.utmEnabled, body.utmMedium])
