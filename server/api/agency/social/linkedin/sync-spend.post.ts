 ...
 *
 * Kicks off linkedin spend sync through the durable queue and returns immediately (falls
...
export default eventHandler(async (event) => {
  ...
  return await startSecondarySpendSyncPlatform(event, 'linkedin', month, year, startedBy)
})
