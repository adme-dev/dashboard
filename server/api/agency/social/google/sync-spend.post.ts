/**
 * Manual Google ad-spend sync kickoff. Thin wrapper over startSpendSyncPlatform so the
...
export default eventHandler(async (event) => {
  ...
  return await startSpendSyncPlatform(event, 'google', month, year, startedBy)
})
