...
export function getInvoiceDate(year: number, month: number): Date {
  // Last day of month (month is 1-indexed here)
...
/**
 * Media (220): Bill at cost x 1.10 (10% margin)
...
export const EOM_CHECKLIST = [
  ...
  { step: 7, task: 'Validate contact names against Xero customers', owner: 'System' },
