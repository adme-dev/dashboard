...
const MODELS: VideoGenerationModel[] = [
  ...
  {
    id: 'aigateway/seedance-2-i2v',
    provider: 'aigateway',
    displayName: 'Seedance 2.0 (image-to-video + native audio)',
    modes: ['image-to-video'],
    allowedSubjectTypes: ['vehicle', 'non_vehicle'],
    requiresApprovedSourceAsset: true,
    supportsNativeAudio: true,
    // Cloudflare's published schema is currently 4-12 seconds. Do not advertise
    // the provider's broader product limits until the Gateway schema exposes them.
    durationsSeconds: [4, 5, 6, 7, 8, 9, 10, 11, 12],
  ...
  },
  {
    ...
    requiresApprovedSourceAsset: true,
    supportsNativeAudio: true,
    durationsSeconds: [4, 5, 8, 10, 12, 16],
    aspectRatios: ['16:9', '9:16', '1:1'],
    resolutions: ['720p', '1080p'],
