-- 367_google_pmax_new_account_bootstrap.sql
...
BEGIN
  ...
  IF v_template_id IS NULL THEN
    RAISE EXCEPTION 'Google PMax Inventory Launch template must exist before migration 367';
  END IF;
  ...
  IF v_phase_id IS NULL THEN
    RAISE EXCEPTION 'Google PMax bootstrap phase must exist before migration 367';
  END IF;
