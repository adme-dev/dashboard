...
ALTER TABLE agency_clients
  ...
  CHECK (lead_capture_mode IN ('analytics_only', 'capture_only', 'full_crm'));
...
COMMENT ON COLUMN agency_clients.lead_capture_mode IS
  'analytics_only: browser events only; capture_only: canonical leads; full_crm: canonical leads plus CRM promotion';
