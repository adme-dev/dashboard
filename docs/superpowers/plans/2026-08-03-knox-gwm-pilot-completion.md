...
- **2026-08-03:** Opened [PR #370](https://github.com/adme-dev/dashboard/pull/370) after confirming the pilot branch was current with `origin/main`. Both Node 24 CI runs passed the full suite, social publishing regression and Pages deployment guard; deploy was correctly skipped. The PR is mergeable and awaits independent review. No Cloudflare production deployment was performed.
