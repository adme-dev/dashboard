...
- [x] Local Graphy/Graphify refreshed after the Workflows smoke shared-secret gate: `pnpm run graphify:rebuild` indexed 3,460 files, generated 8,500 graph nodes and 7,931 edges. Upload target remains `r2://agency-files/graphify/dashboard/`.
