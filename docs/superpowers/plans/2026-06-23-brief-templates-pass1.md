...
- **Two migration files**, underscore convention (matching `190_banner_render_jobs.sql`): `server/database/migrations/191_brief_templates_pass1_new.sql` and `192_brief_templates_pass1_rework.sql`.
...
**Files:**
- Create: `server/database/migrations/191_brief_templates_pass1_new.sql`
- Create: `server/database/migrations/192_brief_templates_pass1_rework.sql`
...
- [ ] **Step 2: Create `191_brief_templates_pass1_new.sql` with header**
...
- [ ] **Step 3: Create `192_brief_templates_pass1_rework.sql` with header + guard**
...
```bash
git add server/database/migrations/191_brief_templates_pass1_new.sql server/database/migrations/192_brief_templates_pass1_rework.sql
git commit -m "feat(briefs): scaffold Pass-1 brief-template migrations 191/192 + zero-data guard"
```
...
**Files:** Modify: `server/database/migrations/191_brief_templates_pass1_new.sql`
...
```bash
git add server/database/migrations/191_brief_templates_pass1_new.sql
...
**Files:** Modify: `191_brief_templates_pass1_new.sql`. Build exactly like Task 2 from this field table; template INSERT: category `digital-marketing`, name `Google Performance Max`, icon `i-lucide-trending-up`, `default_priority 'high'`, sort_order 21.
...
**Files:** Modify: `server/database/migrations/192_brief_templates_pass1_rework.sql`
...
```bash
psql "$DATABASE_URL" -f server/database/migrations/192_brief_templates_pass1_rework.sql
```
...
```bash
git add server/database/migrations/192_brief_templates_pass1_rework.sql
