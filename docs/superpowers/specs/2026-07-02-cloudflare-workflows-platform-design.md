...
4. Set `AGENCY_WORKFLOWS_SMOKE_SHARED_SECRET` as the GitHub Actions repository
   secret for deploy smoke and deploy its SHA-256 verifier as the Pages
   `AGENCY_WORKFLOWS_SMOKE_SHARED_SECRET_SHA256` var.
