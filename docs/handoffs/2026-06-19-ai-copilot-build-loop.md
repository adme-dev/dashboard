...
- **UNREVIEWED — fold into `/code-review high` before merge:** `5e88ccfa`, `ad40b6fa`, `538776f4`, `993d04d4`, `ef13f744`, `43cc73f6`, `9d5d5874`, `b80d4c02`, `dd7444dd`, `a95c3266`. **Visual UAT pending** for all four UIs (my-assistant, PortalCopilot, OfficeCopilot) — consistent with the program's deferred-eyeball convention. Nothing deployed; no flags flipped; not on `main`.
