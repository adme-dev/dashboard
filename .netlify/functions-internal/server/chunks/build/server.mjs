import { defineComponent, readonly, computed, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, hasInjectionContext, inject, shallowRef, h, resolveComponent, effectScope, nextTick, watch, getCurrentScope, onScopeDispose, mergeModels, useModel, createVNode, createCommentVNode, createTextVNode, toDisplayString, useSlots, ref, getCurrentInstance, resolveDynamicComponent, toValue, reactive, provide, cloneVNode, createElementBlock, toRef as toRef$1, onServerPrefetch, Suspense, customRef, isRef, shallowReactive, Fragment, defineAsyncComponent, toRefs, useSSRContext, createApp, renderList, useId, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw, withModifiers, markRaw } from 'vue';
import { A as serialize, B as defu, C as parseQuery, D as hash, E as klona, F as defuFn, G as isEqual, H as hasProtocol, I as joinURL, J as getContext, K as withQuery, L as withTrailingSlash, M as withoutTrailingSlash, N as isScriptProtocol, c as createError$1, O as sanitizeStatusCode, $ as $fetch$1, P as baseURL, Q as createHooks, R as executeAsync, S as toRouteMatcher, T as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "inbox",
    path: "/inbox",
    component: () => import('./inbox-CsUxFeWs.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bpgyf6cV.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/settings",
    component: () => import('./settings-B1r5lovS.mjs'),
    children: [
      {
        name: "settings",
        path: "",
        component: () => import('./index-Czc4srWe.mjs')
      },
      {
        name: "settings-members",
        path: "members",
        component: () => import('./members-CMcKotrk.mjs')
      },
      {
        name: "settings-security",
        path: "security",
        component: () => import('./security-CMqny2Pp.mjs')
      },
      {
        name: "settings-notifications",
        path: "notifications",
        component: () => import('./notifications-DYLxqrWW.mjs')
      }
    ]
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import('./customers-ulGtUxv1.mjs')
  },
  {
    name: "chat",
    path: "/chat",
    component: () => import('./index-zJrF_L47.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./index-CyDmBvq2.mjs')
  },
  {
    name: "cashflow",
    path: "/cashflow",
    component: () => import('./index-BkqXRP1u.mjs')
  },
  {
    name: "expenses",
    path: "/expenses",
    component: () => import('./index-BOJ6OcTn.mjs')
  },
  {
    name: "insights",
    path: "/insights",
    component: () => import('./index-DnSSwHA4.mjs')
  },
  {
    name: "invoices",
    path: "/invoices",
    component: () => import('./index-D0ED9I5G.mjs')
  },
  {
    name: "anomalies",
    path: "/anomalies",
    component: () => import('./index-CuRDRf1A.mjs')
  },
  {
    name: "reports-consolidated",
    path: "/reports/consolidated",
    component: () => import('./consolidated-BSAqd0m8.mjs')
  },
  {
    name: "recommendations",
    path: "/recommendations",
    component: () => import('./index-5U-RF4YJ.mjs')
  }
];
...
const colors_6QXmV_QuDGBcDuG5LtbTAmUQxUW0M_yt6DLgKcbEKns = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  ...
  colors_6QXmV_QuDGBcDuG5LtbTAmUQxUW0M_yt6DLgKcbEKns,
...
_sfc_main$e.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C-VaWthb.mjs').then((m) => m.default || m))
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_b85612ac9055e711c0cdf49df3463bec/node_modules/@nuxt/ui/dist/runtime/components/Error.vue");
...
export { noop as $, formLoadingInjectionKey as A, formOptionsInjectionKey as B, inputIdInjectionKey as C, formFieldInjectionKey as D, pausableFilter as E, getSlotChildrenText as F, _sfc_main$a as G, useNuxtApp as H, useRoute as I, transformUI as J, omit as K, useColorMode as L, pickLinkProps as M, _sfc_main$b as N, __nuxt_component_1$1 as O, createSharedComposable as P, useRouter as Q, useDebounceFn as R, useRequestEvent as S, makeDestructurable as T, watchPausable as U, tryOnMounted as V, camelize as W, toArray as X, watchImmediate as Y, tryOnScopeDispose as Z, _sfc_main$d as _, _sfc_main$9 as a, notNullish as a0, isObject as a1, isDef as a2, injectLocal as a3, pxValue as a4, increaseWithUnit as a5, _sfc_main$c as b, _sfc_main$e as c, useFetch as d, entry$1 as default, __nuxt_component_8 as e, useLocale as f, useAppConfig as g, useAsyncData as h, __nuxt_component_5 as i, reactivePick as j, usePortal as k, useFormField as l, useFieldGroup as m, useComponentIcons as n, isArrayOfArray as o, get as p, compare as q, reactiveOmit as r, getDisplayValue as s, tv as t, useToast as u, looseToNumber as v, formBusInjectionKey as w, formStateInjectionKey as x, formErrorsInjectionKey as y, formInputsInjectionKey as z };
