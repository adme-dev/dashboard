import { defineComponent, getCurrentScope, onScopeDispose, computed, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, readonly, hasInjectionContext, inject, shallowRef, h, resolveComponent, effectScope, nextTick, watch, createVNode, resolveDynamicComponent, ref, toDisplayString, getCurrentInstance, useSlots, createCommentVNode, createTextVNode, Fragment, renderList, mergeModels, useModel, toValue, reactive, provide, cloneVNode, createElementBlock, toRef as toRef$1, onServerPrefetch, Suspense, customRef, isRef, shallowReactive, defineAsyncComponent, toRefs, useSSRContext, createApp, useId, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw, withModifiers, markRaw } from 'vue';
import { F as serialize, G as hasProtocol, H as isScriptProtocol, I as joinURL, J as isEqual, K as defu, L as parseQuery, M as hash, N as defuFn, O as klona, P as withQuery, Q as sanitizeStatusCode, R as getContext, S as withTrailingSlash, T as withoutTrailingSlash, c as createError$1, $ as $fetch$1, U as baseURL, V as createHooks, W as executeAsync, X as toRouteMatcher, Y as createRouter$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderVNode, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSuspense } from 'vue/server-renderer';
...
const unhead_d6TUFM02oQ1QDkDt868FgK6uHPrZ37lWpRSiCA8EmrE = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "inbox",
    path: "/inbox",
    component: () => import('./inbox-DBfzGJNP.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bq8LyDQA.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/settings",
    component: () => import('./settings-DyhvuAPw.mjs'),
    children: [
      {
        name: "settings",
        path: "",
        component: () => import('./index-BU5u3jiV.mjs')
      },
      {
        name: "settings-members",
        path: "members",
        component: () => import('./members-Bg4mOXxm.mjs')
      },
      {
        name: "settings-security",
        path: "security",
        component: () => import('./security-BXRZjEjt.mjs')
      },
      {
        name: "settings-notifications",
        path: "notifications",
        component: () => import('./notifications-CkSCYoO2.mjs')
      }
    ]
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import('./customers-Dn-7eOjd.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-DnWxwe96.mjs')
  },
  {
    name: "chat",
    path: "/chat",
    component: () => import('./index-wSIW8Kyx.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./index-QJCb6l5k.mjs')
  },
  {
    name: "cashflow",
    path: "/cashflow",
    component: () => import('./index-BCNCfXFY.mjs')
  },
  {
    name: "expenses",
    path: "/expenses",
    component: () => import('./index-TBQKL5Su.mjs')
  },
  {
    name: "insights",
    path: "/insights",
    component: () => import('./index-CfMrdCGq.mjs')
  },
  {
    name: "invoices",
    path: "/invoices",
    component: () => import('./index-Bo1uPpnA.mjs')
  },
  {
    name: "anomalies",
    path: "/anomalies",
    component: () => import('./index-CUp33shI.mjs')
  },
  {
    name: "profit-loss",
    path: "/profit-loss",
    component: () => import('./index-BzRKwOku.mjs')
  },
  {
    name: "reports-consolidated",
    path: "/reports/consolidated",
    component: () => import('./consolidated-BGTGOzZ8.mjs')
  },
  {
    name: "recommendations",
    path: "/recommendations",
    component: () => import('./index-CNpn_P96.mjs')
  }
];
...
const require_45xero_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  let __temp, __restore;
  ...
  const { data } = ([__temp, __restore] = executeAsync(() => useFetch("/api/xero/status", "$8XY-mlHKU4")), __temp = await __temp, __restore(), __temp);
...
const revive_payload_server_V_pJM6PgQ0Eg1vqp6VoaMQPZqxWjbTbs9adpjZHRU9c = /* @__PURE__ */ defineNuxtPlugin({
...
const colors_GLZhSodrszLDyGKo_NeHDx4TyItvV1JqrETzkLk4_as = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_YEOM_OoJsHG9kSF5Cao9Mogg3_BijFqDsWp1zSXtHfE = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const plugins = [
  unhead_d6TUFM02oQ1QDkDt868FgK6uHPrZ37lWpRSiCA8EmrE,
  plugin,
  revive_payload_server_V_pJM6PgQ0Eg1vqp6VoaMQPZqxWjbTbs9adpjZHRU9c,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_GLZhSodrszLDyGKo_NeHDx4TyItvV1JqrETzkLk4_as,
  plugin_server_LlmVocchW81w0V5SsaJLemsIvF2IHoteTyzHWZjumlg,
  plugin_YEOM_OoJsHG9kSF5Cao9Mogg3_BijFqDsWp1zSXtHfE
];
...
_sfc_main$e.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CgBEryhL.mjs').then((m) => m.default || m))
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.2_@babel+parser@7.28.0_@netlify+blobs@9.1.2_axios@1.12.2_change-ca_9e32dd265ffe56b992951caaa30208b5/node_modules/@nuxt/ui/dist/runtime/components/Error.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.0.3_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@24.0.3_@vue+compiler-_a80f18eca66715f7b0746c407a09cec0/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { tryOnScopeDispose as $, formOptionsInjectionKey as A, inputIdInjectionKey as B, formFieldInjectionKey as C, navigateTo as D, compare as E, _sfc_main$a as F, pickLinkProps as G, _sfc_main$b as H, pausableFilter as I, getSlotChildrenText as J, useNuxtApp as K, useRoute as L, transformUI as M, omit as N, useColorMode as O, __nuxt_component_1$1 as P, createSharedComposable as Q, useRouter as R, useDebounceFn as S, useRequestEvent as T, makeDestructurable as U, watchPausable as V, tryOnMounted as W, camelize as X, toArray as Y, watchImmediate as Z, _sfc_main$e as _, _sfc_main$c as a, isDef as a0, noop as a1, notNullish as a2, isObject as a3, injectLocal as a4, pxValue as a5, increaseWithUnit as a6, _sfc_main$8 as a7, _sfc_main$d as b, useToast as c, _sfc_main$9 as d, entry$1 as default, useFetch as e, __nuxt_component_2$1 as f, get as g, useLocale as h, reactiveOmit as i, useAsyncData as j, __nuxt_component_5 as k, useFormField as l, useComponentIcons as m, looseToNumber as n, usePortal as o, useFieldGroup as p, isArrayOfArray as q, reactivePick as r, getDisplayValue as s, tv as t, useAppConfig as u, formBusInjectionKey as v, formStateInjectionKey as w, formErrorsInjectionKey as x, formInputsInjectionKey as y, formLoadingInjectionKey as z };
