...
describe('Page Studio publishing workspace', () => {
  it('keeps Studio authoring separate from site management', () => {
    ...
    expect(management).toContain('PageStudioAssetsWorkspace')
    expect(management).toContain('PageStudioFormSubmissionsWorkspace')
    expect(management).toContain('PageStudioAnalyticsWorkspace')
    expect(management).toContain('PageStudioDomainsWorkspace')
    expect(management).toContain('PageStudioSessionsWorkspace')
