...
describe('ai model registry', () => {
  it('covers the expected phase-1 feature inventory', () => {
    ...
    expect(features.has('banner_image_generation')).toBe(true)
    expect(features.has('banner_image_edit')).toBe(true)
    expect(features.has('banner_image_layer_decomposition')).toBe(true)
