...
describe('God mode internal execution delegation', () => {
  ...
  it.each([
    ...
    ['/api/agency/analytics/campaigns', [['startDate', '2026-08-01'], ['endDate', '2026-08-05'], ['sortBy', 'spend'], ['sortDir', 'desc'], ['showInactive', 'true'], ['limit', '200'], ['offset', '0'], ['platform', 'meta']]],
    ['/api/agency/analytics/campaigns', [['startDate', '2026-08-01'], ['endDate', '2026-08-05'], ['sortBy', 'spend'], ['sortDir', 'desc'], ['showInactive', 'true'], ['limit', '200'], ['offset', '200']]],
  ...
  it.each([
    ...
    ['GET', '/api/agency/analytics/campaigns?startDate=2026-08-01&endDate=2026-08-05&sortBy=spend&sortDir=asc&showInactive=true&limit=200&offset=0'],
    ['GET', '/api/agency/analytics/campaigns?startDate=2026-08-01&endDate=2026-08-05&sortBy=spend&sortDir=desc&showInactive=false&limit=200&offset=0'],
    ['GET', '/api/agency/analytics/campaigns?startDate=2026-08-01&endDate=2026-08-05&sortBy=spend&sortDir=desc&showInactive=true&limit=200&offset=-1'],
