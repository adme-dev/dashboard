...
vi.mock('~~/server/utils/pageStudio/workflowUpgradeIntent', () => ({
  preparePageStudioWorkflowUpgrade: mocks.prepare
}))
vi.mock('~~/server/utils/pageStudio/workflowUpgradeAuthority', () => ({
  authorizePageStudioWorkflowUpgrade: mocks.authorize
}))
...
const intent = {
  version: 1,
  policyVersion: 'workflow-upgrade-v1',
  ...
  sourceDigest: '0feb591f4c5fcb82c9b10204f7e387e83b4eb52eb634ce772f8cad8716ca0cee',
  targetDigest: '60631223175cb7e8bf9dca5b08347a192844b8600bd8687e1caa8b60c9f337ae'
}
      ...
      event.context.cloudflare = {
        env: {
          ...
          PAGE_STUDIO_PROVISIONER: {
            createProvisioning() {},
            readProvisioning() {},
            executeWorkflowUpgrade: mocks.execute,
            readWorkflowUpgradeOperation: mocks.status
          }
        }
      } as never
      return handlePageStudioWorkflowSetup(event, 'portal', method)
    },
