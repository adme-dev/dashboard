...
const migration = readFileSync(
  new URL('../../server/database/migrations/368_google_pmax_decision_evidence_snapshots.sql', import.meta.url),
  'utf8'
)

describe('Google PMax evidence snapshots migration 368', () => {
