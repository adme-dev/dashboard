...
const migration = readFileSync(
  new URL('../../server/database/migrations/358_google_pmax_decision_evidence_identity_check.sql', import.meta.url),
  'utf8'
)

describe('Google PMax evidence identity migration 358', () => {
