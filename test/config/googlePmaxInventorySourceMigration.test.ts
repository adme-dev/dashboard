...
const migration = readFileSync(
  new URL('../../server/database/migrations/353_google_pmax_inventory_source_and_asset_mode.sql', import.meta.url),
  'utf8'
)

describe('Google PMax inventory source and asset mode migration 353', () => {
