...
const migration = readFileSync(
  new URL('../../server/database/migrations/354_google_pmax_launch_project_template.sql', import.meta.url),
  'utf8'
)

describe('Google PMax launch project template migration 354', () => {
