/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 3341248178d292cb2d9a934fd8d450ce)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	EXPECTED_R2_ACCOUNT_ID: "CONFIGURE_BEFORE_DEPLOY";
	EXPECTED_R2_BUCKET: "agency-files";
	SCAN_CONTAINER: DurableObjectNamespace<import("./index").ClamAvContainer>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXPECTED_R2_ACCOUNT_ID" | "EXPECTED_R2_BUCKET">> {}
}
